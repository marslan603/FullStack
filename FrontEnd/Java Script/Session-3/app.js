...
console.log(today);
console.log(today.getFullYear());
console.log(`day of month ${today.getDate()}, month of year is ${today.getMonth() +1}, year is ${today.getFullYear()}`);*/
...
//const result = (`${num1%10 == num2%10} || ${num1%10 == num3%10} || ${num3%10 == num2%10}`);

//console.log(`${result}`);



let num1 = +prompt('Enter first number1');
let num2 = +prompt('Enter first number2');
